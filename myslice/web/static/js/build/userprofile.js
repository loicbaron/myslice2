...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserProfile = __webpack_require__(345);

	var _UserProfile2 = _interopRequireDefault(_UserProfile);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactDom2.default.render(_react2.default.createElement(_UserProfile2.default, null), document.getElementById('user-profile'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserProfileActions = __webpack_require__(220);

	var _UserProfileActions2 = _interopRequireDefault(_UserProfileActions);

	var _ProfileSource = __webpack_require__(221);

	var _ProfileSource2 = _interopRequireDefault(_ProfileSource);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

	var UserProfileStore = function () {
	    function UserProfileStore() {
	        ...
	        this.bindListeners({
	            //changes views
	            updateFirstname: _UserProfileActions2.default.UPDATE_FIRSTNAME,
	            updateLastname: _UserProfileActions2.default.UPDATE_LASTNAME,
	            updateBio: _UserProfileActions2.default.UPDATE_BIO,
	            updateUrl: _UserProfileActions2.default.UPDATE_URL,

	            //async requests
	            initUser: _UserProfileActions2.default.INIT_USER,
	            onSubmit: _UserProfileActions2.default.ON_SUBMIT,
	            updateLoading: _UserProfileActions2.default.UPDATE_LOADING,

	            //update views from rest api results
	            updateUser: _UserProfileActions2.default.UPDATE_USER,
	            errorupdateUser: _UserProfileActions2.default.ERRORUPDATE_USER
	        });

	        this.registerAsync(_ProfileSource2.default);
	    }
	    /*
	    ...
	    */
	    ...
	    _createClass(UserProfileStore, [{
	        ...
	        */
	        ...
	        key: 'updateUser',
	        value: function updateUser(response) {
	            this.setState(response.data.result);
	        }
	    }, {
	        key: 'errorupdateUser',
	        value: function errorupdateUser(errorMessage) {
	...
	exports.default = _alt2.default.createStore(UserProfileStore, 'UserProfileStore');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserProfileActions = function () {
	    ...
	    _createClass(UserProfileActions, [{
	        ...
	        key: 'errorupdateUser',
	        value: function errorupdateUser(error) {
	            return error;
	        }
	    }, {
	        key: 'updateLastname',
	...
	exports.default = _alt2.default.createActions(UserProfileActions);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserProfileSource = function UserProfileSource() {
	    return {
	        initUser: {
	            // remotely fetch something (required)

	            remote: function remote(state) {
	                return _axios2.default.get('/api/v1/profile');
	            },
	            ...
	            success: _UserProfileActions2.default.updateUser, // (required)
	            error: _UserProfileActions2.default.errorupdateUser, // (required)
	        ...
	        onSubmit: {
	            remote: function remote(state) {
	                return _axios2.default.put('/api/v1/profile', {
	                    data: {
	...
	exports.default = UserProfileSource;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserProfileStore = __webpack_require__(219);
	...
	var _AuthorityName = __webpack_require__(346);

	var _AuthorityName2 = _interopRequireDefault(_AuthorityName);
	...
	var UserProfile = function (_React$Component) {
	    ...
	    function UserProfile(props) {
	        ...
	        _this.state = _UserProfileStore2.default.getState();
	    ...
	    _createClass(UserProfile, [{
	        ...
	        value: function componentDidMount() {
	            _UserProfileStore2.default.listen(this.onChange);
	            _UserProfileActions2.default.initUser();
	        }
	    }, {
	        key: 'componentWillUnmount',
	        value: function componentWillUnmount() {
	            _UserProfileStore2.default.unlisten(this.onChange);
	        }
	        ...
	        value: function updateLastname(event) {
	            _UserProfileActions2.default.updateLastname(event.target.value);
	        }
	    }, {
	        key: 'updateFirstname',
	        value: function updateFirstname(event) {
	            _UserProfileActions2.default.updateFirstname(event.target.value);
	        }
	    }, {
	        key: 'updateBio',
	        value: function updateBio(event) {
	            _UserProfileActions2.default.updateBio(event.target.value);
	        }
	    }, {
	        key: 'updateUrl',
	        value: function updateUrl(event) {
	            _UserProfileActions2.default.updateUrl(event.target.value);
	        }
	    }, {
	        key: 'submitForm',
	        value: function submitForm(event) {
	            event.preventDefault();
	            _UserProfileActions2.default.onSubmit();
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        null,
	                        _react2.default.createElement('input', { value: this.state.first_name,
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        null,
	                        _react2.default.createElement('input', { value: this.state.last_name,
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        null,
	                        _react2.default.createElement('input', { value: this.state.email,
	                            name: 'email',
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        null,
	                        _react2.default.createElement(_AuthorityName2.default, { id: this.state.authority })
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        null,
	                        _react2.default.createElement('input', { value: this.state.bio,
	                            placeholder: 'Bio',
	                            type: 'text',
	                            name: 'bio',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AuthorityName = function (_React$Component) {
	    _inherits(AuthorityName, _React$Component);

	    function AuthorityName(props) {
	        _classCallCheck(this, AuthorityName);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AuthorityName).call(this, props));

	        _this.state = {
	            authname: ''
	        };

	        _this.fetchAuthorityName = _this.fetchAuthorityName.bind(_this);
	        return _this;
	    }

	    _createClass(AuthorityName, [{
	        ...
	        key: 'fetchAuthorityName',
	        value: function fetchAuthorityName() {
	            _axios2.default.get('/api/v1/authorities/' + this.props.id).then(function (response) {
	        ...
	        key: 'updateAuthorityName',
	        value: function updateAuthorityName(data) {
	        ...
	        key: 'errorAuthorityName',
	        value: function errorAuthorityName(date) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement('input', { value: this.state.authname || this.props.id,
